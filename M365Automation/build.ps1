...
$username = "admin@ykuijs.onmicrosoft.com"
...
$null = ConfigureMicrosoft365 -credsGlobalAdmin $cred -ConfigurationData .\M365ConfigurationData.psd1 -OutputPath $outputFolder
